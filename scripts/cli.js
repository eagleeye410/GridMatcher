...
const contractABI = require("../artifacts/contracts/Gridmatcher.sol/Gridmatcher.json").abi;

program
    .name("gridmatcher-cli")
    .description("CLI tool for Gridmatcher smart contract")
    .version("1.0.0");
