 ...
 * This file demonstrates how to integrate Gridmatcher with a web frontend
 */

// For React/Vue/Angular applications
export class GridmatcherClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new GridmatcherClient(provider, contractAddress);
